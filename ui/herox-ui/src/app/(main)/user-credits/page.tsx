...
import TableUserCreditsManager from "@/components/Table/TableUserCreditsManager";
      ...
      <BoxCustom>
        ...
        <div>
          ...
          <p className="subtitle text-[#7987a1] fs-12 fw-normal ml-[11px]">
            View and monitor X Interaction Credits for registered telegram users
          </p>
        </div>

        {/* body */}
        <div className="mt-6">
          <TableUserCreditsManager />
        </div>
      </BoxCustom>
    </div>
  );
